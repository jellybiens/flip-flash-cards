...
import { CardFace, FlipCardWrapper } from '@components';
import { CustomColours, FlipCardProps } from '@types';

const title = 'FlipCardWrapper';

const front1 = {
  colour: 'cyan' as CustomColours,
  text: 'Spongebob',
  imgLink: 'https://nickelodeonuniverse.com/wp-content/uploads/Spongebob.png',
};
const back1 = {
  colour: 'lime' as CustomColours,
  text: 'Squarepants',
  imgLink:
...
const back2 = {
  colour: 'black' as CustomColours,
  text: 'Patrick',
};
const front3 = {
  colour: 'purple' as CustomColours,
  text: 'Squidward',
  imgLink: 'https://i.ytimg.com/vi/5SbOeQp1EiI/maxresdefault.jpg',
};
const back3 = {
  colour: 'blue' as CustomColours,
  text: 'Squidward',
  imgLink:
...
const cardProps1 = { _id: 'qwe', front: front1, back: back1 };
const cardProps2 = { _id: 'rty', front: front2, back: back2 };
const cardProps3 = { _id: 'uio', front: back3, back: front3 };
