...
const cardProps1 = { cardId: 'qwe', front: front1, back: back1 };
const cardProps2 = { cardId: 'rty', front: front2, back: back2 };
const cardProps3 = { cardId: 'uio', front: back3, back: front3 };
